...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors
						.basePackage("com.fiap.pet.resources"))// pacotes rastreáveis do swagger
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API Para serviço de PET..",
				"API do trabalho da fase 4 do curso FIAP - Full Stack Development", "Versão 1.0", "..terms",
				new Contact("Thiago Cessin", "", "thiagoacessin@gmail.com"), "", "..terms", Collections.emptyList() // Vendor
																													// Extensions
		);
	}
